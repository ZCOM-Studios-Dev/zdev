--[[
	...
	A throwable flashba``ng weapon derived from zdev_weapon_base_throwable.
	Spawns zdev_grenade_flashbang entities when thrown.
...
SWEP.Purpose 						= "High-explosive grenade that deals damage to nearby targets within its radius"
...
SWEP.Projectile 					= {}
SWEP.Projectile.WorldModel 			= "models/weapons/w_eq_flashbang.mdl"
SWEP.Projectile.ViewModel 			= "models/weapons/w_eq_flashbang.mdl"
...
SWEP.Projectile.Entity 				= "zdev_ent_grenade_flashbang"			-- The flashbang entity class
