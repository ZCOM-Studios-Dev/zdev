...
SWEP.Projectile                     = {}
SWEP.Projectile.WorldModel          = "models/weapons/w_eq_fraggrenade.mdl"
SWEP.Projectile.ViewModel           = "models/weapons/w_eq_fraggrenade.mdl"
...
SWEP.Projectile.Entity              = "zdev_ent_grenade_he"			-- The HE grenade entity class
